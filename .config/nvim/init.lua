...
vim.schedule(function()
  --  Notice clipboard is set using `vim.opt` instead of `vim.o`.
...
vim.o.tabstop = 4 -- number of spaces inserted when tab key pressed
vim.o.softtabstop = 4 -- number of spaces inserted when tab key pressed
vim.o.shiftwidth = 4 -- number of spaces inserted by < & > indent motions
